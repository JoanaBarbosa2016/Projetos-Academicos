...
public class JFrameBuscarAluno extends javax.swing.JFrame {
    AlunoDataAccessObject aluno = new AlunoDataAccessObject();
    ...
    public JFrameBuscarAluno() {
        initComponents();
         try {
            ArrayList<Aluno> alunos = aluno.listarAlunos("");
            for(Aluno a : alunos){
                DefaultTableModel model = (DefaultTableModel) jTableAluno.getModel();
               Object linha[] =  new Object[]{ a.getNome(),a.getCodigo(), a.getCpf()};
                model.addRow(linha);
            }
    ...
    private void jTextFieldObterDados1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldObterDados1ActionPerformed
     ...
     private void filtrarAlunos(java.awt.event.KeyEvent evt) {                             
        try {
            ArrayList<Aluno> alunos = aluno.listarAlunos(jTextFieldObterDados1.getText());
            ...
            JOptionPane.showMessageDialog(null, "Erro ao exibir alunos.");
        }
     }
